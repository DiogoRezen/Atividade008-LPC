...
class Game:
    ...
    def __init__(self):
        ...
        self.spider1 = NPMobileObj("assets/spider1.png",random.randrange(0, cf.SIZE_WINDOW_X - 40), cf.POSITION_Y_SPIDER)                                                       
        self.flower1 = NPMobileObj("assets/florwer1.png",random.randrange(0, cf.SIZE_WINDOW_X - 40), cf.POSITION_Y_FLOWER)                                         
    ...
    def update(self):
        ...
        self.spider1.movement(cf.TAX_UPDATE_Y_SPIDER)
        self.spider1.reset ("assets/spider1.png", cf.LIM_Y_SPIDER, cf.POSITION_Y_SPIDER)      
        self.flower1.anim("florwer", cf.N_TICKS_FLOWER, cf.N_SPRITES_FLOWER)        
        self.flower1.movement(cf.TAX_UPDATE_Y_FLOWER)
        self.flower1.reset("assets/florwer1.png", cf.LIM_Y_FLOWER, cf.INITIAL_POSITION_FLOWER_Y)
